...
function mouseMoveHandler(event) {
    ...
    if (event.buttons === 1) {
        let toX = event.offsetX, toY = event.offsetY, fromX = toX - event.movementX, fromY = toY - event.movementY;
...
function mouseMoveHandler(event) {
    ...
    if (event.buttons === 1) {
        // @ts-ignore
        let ctx = inputCanvas.getContext('2d'), toX = event.offsetX, toY = event.offsetY, fromX = toX - event.movementX, fromY = toY - event.movementY;
